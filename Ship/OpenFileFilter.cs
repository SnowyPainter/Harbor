...
namespace ADPC.Ship
{
    public class OpenFileFilter
    {
        ...
        public OpenFileFilter(string year, string month, string day)
        {
            Year = year;
            Month = month;
            Day = day;
        }
        public OpenFileFilter(string year, string month) : this(year, month, "") { }
        public OpenFileFilter(string year) : this(year, "", "") { }
        /// <summary>
        /// ToString()
        /// 2020*
        /// 202010*
